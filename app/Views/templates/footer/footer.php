<footer>
                                ...
                                <div class="textwidget">
                                    ...
                                    <p><span style="font-size: 15px; color: #ffffff;">+1-2534-4456-345</span>
                                        ...
                                        <br /> <a style="font-size: 15px; color: #ffffff;"
                                            href="mailto:admin@kingsteruni.edu">info@charusat.ac.in</a>
                                    </p>
                                    <div
                ...
                <div class="kingster-copyright-wrapper">
                    <div class="kingster-copyright-container kingster-container clearfix">
                        <div class="kingster-copyright-left kingster-item-pdlr">Copyright All Right Reserved 2019, Max
                            Themes</div>
